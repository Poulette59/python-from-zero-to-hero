#Hacer un programa que determine el perimetro de una torta en centímetros.
...
perimetro = 2 * 3.14 * cake_radius

print("El perímetro de la torta es", perimetro,"centímetros")
